...
{
    public  class eStoreFileManager
    {
        public enum eStoreFileType { NetTerm, Reseller, PurchaseOrder , SystemIntegrator }
        ...
        public static string save(eStoreFileType type, FileUpload fileUpload)
          {
              ...
              if (fileUpload.HasFile)
              {
                  try
                  {
                      ...
                      string path = System.Configuration.ConfigurationManager.AppSettings["UserCertificateFiles"];
