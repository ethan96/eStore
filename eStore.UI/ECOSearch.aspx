<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Configurable.Master" AutoEventWireup="true"
    CodeBehind="ECOSearch.aspx.cs" Inherits="eStore.UI.ECOSearch" %>

<%@ Register Src="Modules/ECO/ECOPartnerSearch.ascx" TagName="ECOPartnerSearch" TagPrefix="uc1" %>
<%@ Register Src="Modules/CountrySelector.ascx" TagName="SelectCountry" TagPrefix="uc1" %>
<%@ Register Src="Modules/ServerTime.ascx" TagName="ServerTime" TagPrefix="uc2" %>
<asp:Content ID="Content2" ContentPlaceHolderID="eStoreConfigurableRightContent" runat="server">
     <eStore:liveperson ID="liveperson2" runat="server" /> 
...
<asp:Content ID="Content3" ContentPlaceHolderID="eStoreMainContent" runat="server">
    <div id="ecoParterList">
        ...
        <asp:Image ID='imgEcosystem' runat="server" ImageUrl="~/Images/Ecosystem_Partnership_Banner1.jpg" ToolTip="Your Ecosystem Partners" />
        </div>
        ...
        <asp:Repeater ID="rpECOSearch" runat="server">
            <ItemTemplate>
                <div class="ecoParter-List">
                    ...
                    <ul>
                        <li class="clear"><span class="ecoMtitle">Company:</span>
                            <p class="ecoMDes">
                                <%#Eval("CompanyName")%></p>
                        </li>
                        <li class="clear"><span class="ecoMtitle">Industries:</span>
                            <p class="ecoMDes">
                                <%#Eval("IndustryX") %></p>
                        </li>
                        <li class="clear"><span class="ecoMtitle">Website:</span>
                            <p class="ecoMDes">
                                <%#Eval("WebSiteUrl") %></p>
                        </li>
                        <li class="clear"><span class="ecoMtitle">Office:</span>
                            <p class="ecoMDes">
                               <%#Eval("CountryName")%> <%#Eval("State")%> <%#Eval("Address") %></p>
                        </li>
                        <li class="clear"><span class="ecoMtitle">About:</span>
                            <p class="ecoMDes">
                                <%#Eval("Description") %></p>
                        </li>
                    </ul>
    ...
    <div id="ecoRequestAssistance" class="hiddenitem">
        <ul>
            <li class="clear"><span class="ecoInPartner-title fontbold">Project Name:</span>
            ...
            <li class="clear"><span class="ecoInPartner-title fontbold">Product Interest:</span>
                <p class="ecoInPartner-onecolumn">
                    <asp:TextBox ID="txtRa_InterestPro" runat="server" Width="350px" CssClass="ecoPaPaMustPut"></asp:TextBox><span
                        class="colorRed">*</span></p>
            </li>
            <li class="clear"><span class="ecoInPartner-title fontbold">Budget:</span>
                <p class="ecoInPartner-onecolumn">
            ...
            <li class="clear"><span class="ecoInPartner-title fontbold">Project Details:</span>
                <p class="ecoInPartner-onecolumn">
    ...
    <div id="ecoEmailFrinds" class="hiddenitem">
        ...
        <p class="clear">
            <span class="ecoEmailFrinds-title">Your Friend’s E-mail:</span><asp:TextBox ID="txtFr_FrindsEmail"
                runat="server" Width="225px" CssClass="ecoFrPaMustPut mustEmail"></asp:TextBox><span class="colorRed">*</span></p>
        <p class="ecoButton-Below">
