...
namespace eStore.UI.Modules
{
    public partial class CartContactTemplate : Presentation.eStoreBaseControls.eStoreBaseUserControl
    {
        ...
        public event EventHandler eEditContact;
        ...
        public bool ShowEdit
        {
            ...
            set {
                _ShowEdit = value;
                btEditContact.Visible = value;
            }
        }
        

        public string EditContactCommName
        {
            get { return btEditContact.CommandName; }
            set { btEditContact.CommandName = value; }
        }
        ...
        public POCOS.CartContact cartContact
        {
            set
            {
                ...
                this.ltHeaderText.Text = HeaderText;
        ...
        {
            if (eEditContact != null)
                btEditContact.Click += eEditContact;
        }
    }
}