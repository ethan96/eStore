<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Paypal.ascx.cs" Inherits="eStore.UI.Modules.Payment.Paypal" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <br />
                    <br />
                    <a target="_blank" href="/information.aspx?type=PrivacyPolicy">
...
<!--eStore_order_radioList_content-->
...
<script type="text/javascript" language="javascript">
    ...
    <% if (eStore.Presentation.eStoreContext.Current.Store.storeID=="AAU")
    {%>
    //there will be 3% surcharge to AMEX Payment
    
    var defaultoption=$("#<%=ddlcardtype.ClientID %>").val();
     $("#<%=ddlcardtype.ClientID %>").change(function(){
         if($(this).val()=="American Express")
         {
             if(!confirm("there will be 3% surcharge to AMEX Payment"))
             {
                $("#<%=ddlcardtype.ClientID %>").val(defaultoption);
             }
         }
     });
