...
(function ($) {
    var Bubble = function (elm, options) {
        ...
        self.$elm = $(elm);
        self.opts = options;
        self.$box = $('<div class="sBubble" id="b'+options.id+'"></div>').append(options.content)
                                               .addClass(options.position + ' ' + options.theme);
        self.$arw = $('<div class="sBubbleArw" id="ba'+options.id+'"> </div>').addClass(options.position + ' ' + options.theme);
