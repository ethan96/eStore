...
;(function($, undefined) {
	...
	function Tooltip($trigger, options) {
		...
		this.$tooltip = $('<div class="scotooltip"><span></span><div class="pointer"></div></div>').appendTo(this.options.appendTo).hide();
	...
	$.fn[pluginName].defaults = {
		...
		,contentAttr: null
        , content: ''
        , hoverable: false		// should mouse over tooltip hold the tooltip or not?
		,delay: 0
		,cssclass: ''
