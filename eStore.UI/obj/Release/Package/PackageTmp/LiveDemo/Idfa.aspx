<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ThreeColumn.Master" AutoEventWireup="true" CodeBehind="Idfa.aspx.cs" Inherits="eStore.UI.LiveDemo.Idfa" %>
		...
		<tr>
			<td valign="top">
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td valign="bottom">
										<img src="/images/LiveDome/menu_fa03.gif" name="Image18" width="205" height="13" border="0" alt="" />
									</td>
									<td rowspan="3">
										<img src="/images/LiveDome/menu01.gif" width="4" height="30" alt="" />
									</td>
							...
							<table class="bodytext" cellspacing="5" cellpadding="10" width="100%" border="0">
								<tr valign="bottom">
									<td height="75" valign="top">
										<img src="/images/LiveDome/title_fa.gif" width="483" height="75" title="<%=liveDemoSubTitle%>" alt="" />
									</td>
								</tr>
								<tr valign="top">
									<td height="115" align="left" valign="top">
										<div align="left">
											<p class="body">
												Waste Water Treatment is one of typical Environmental Monitoring applications. The main processes includes Screening, Aerating, Sludge Removing, and Bacteria Killing. In screening stage, ADAM-4017+ Analog Input module takes response to monitor the floating rate in case of the pipeline entry been plugged. Once the floating rate drop down, the ADAM-4055 Digital I/O module will issue alarms to operators to clean the big size garbage from pipeline entry. In Aerating stage, the ADAM-4055 will control the miller and Oxygen supply. In Sludge Removing stage, the ADAM-4017+ will work as a gate keeper to monitor the turbidity of waste water before outlet to next process. In Bacteria Killing stage, ADAM-5510KW can control the Chlorine and PH Chemical Material supply through ADAM-5055 DI/O module. Then the ADAM-5017 continuous watch the PH value in the latest stage.</p>
											<p class="body">
												The whole waste water treatment system is control by ADAM-5510KW basing on RS-485 networking. It collect the local data from ADAM-5000 I/O modules and remote data from ADAM-4000 I/O modules, then feedback to the supervisory center for operator to manage the whole process.</p>
										</div>
										<br />
									</td>
								</tr>
				...
				<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="770" height="400">
					<param name="movie" value="/images/LiveDome/demo_fa.swf" />
					<param name="quality" value="high" />
					<%--<embed src="/images/LiveDome/demo_fa.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="770" height="400"></embed>--%>
				</object>
			</td>
		</tr>
	</table>
