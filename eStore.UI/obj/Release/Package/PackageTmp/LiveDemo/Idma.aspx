<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ThreeColumn.Master" AutoEventWireup="true" CodeBehind="Idma.aspx.cs" Inherits="eStore.UI.LiveDemo.Idma" %>
		...
		<tr>
			<td valign="top">
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td valign="top">
										<img src="/images/LiveDome/menu_ma03.gif" name="Image23" width="205" height="13" border="0" alt="" />
									</td>
								</tr>
							</table>
						</td>
								...
								<tbody>
									<tr valign="bottom">
										<td height="75" valign="top">
											<img src="/images/LiveDome/title_ma.gif" width="483" height="75" title="<%=liveDemoSubTitle%>" alt="" />
										</td>
									</tr>
									<tr valign="top">
										<td height="115" align="left" valign="top">
											<div align="left">
												<p class="body">
													Advantech's motion, I/O and encoder cards are widely used in automated SMD component mounting machines. SMD component mounting has very demanding requirements for accurate positioning, since busy production lines need very high speeds.
												</p>
												<p class="body">
													By integrating Advantech's motion, I/O, and encoder cards, mounting machine builders can develop programs that are customized for their systems, and ensure that their demanding requirements are met.</p>
											</div>
											<br />
										</td>
									</tr>
				...
				<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="770" height="400">
					<param name="movie" value="/images/LiveDome/demo_ma.swf" />
					<param name="quality" value="high" />
					<%--<embed src="/images/LiveDome/demo_ma.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="770" height="400"></embed>--%>
				</object>
			</td>
		</tr>
	</table>
