        ...
        <td>
            ...
            <div class="eStore_information">
                ...
                <div class="eStore_ShippingPersonal" lb="hIsSoldto">
                    ...
                    <div class="eStore_addReceiver">
                        <span contactType="Sold" class="btn showAddress fancybox"><%=eStore.Presentation.eStoreLocalization.Tanslation(eStore.POCOS.Store.TranslationKey.eStore_Add_a_new_shipping_address)%></span>
                    </div>
                    <!--Add a receiver-->
                </div>
                <!--eStore_ShippingPersonal-->
