<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HomeMedialContent2016.ascx.cs" EnableViewState ="false"
    Inherits="eStore.UI.Modules.HomeMedialContent2016" %>
...
<eStore:Repeater ID="rpSolutions" runat="server" OnItemDataBound="rpSolutions_ItemDataBound">
    ...
    <div class="eStore_index_Highlight">
        <h1 class="eStore_index_solutionTitle">
