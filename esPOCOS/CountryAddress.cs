...
namespace eStore.POCOS
{
    public partial class CountryAddress
    {
    	...
    	/* public void Write()
        {
            Type type = typeof(CountryAddress); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.CountryAddresses.Contains(this))
            {
                previousValue.CountryAddresses.Remove(this);
            }
    
            if (Address != null)
            {
                if (!Address.CountryAddresses.Contains(this))
                {
                    Address.CountryAddresses.Add(this);
                }
        ...
        private void FixupCountry(Country previousValue)
        {
            ...
            if (Country != null)
            {
                if (!Country.CountryAddresses.Contains(this))
                {
                    Country.CountryAddresses.Add(this);
                }
