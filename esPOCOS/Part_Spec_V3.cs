...
namespace eStore.POCOS
{
    public partial class Part_Spec_V3
    {
        ...
        public virtual string MainPartModelNo
        {
            get;
            set;
        }
    	...
    	/* public void Write()
        {
            Type type = typeof(Part_Spec_V3); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.Part_Spec_V3.Contains(this))
            {
                previousValue.Part_Spec_V3.Remove(this);
            }
    
            if (Spec_Category != null)
            {
                if (!Spec_Category.Part_Spec_V3.Contains(this))
                {
                    Spec_Category.Part_Spec_V3.Add(this);
                }
