...
{
    public partial class PriceAdjustRule
    {
    	...
    	public bool validate() {
		 ...
		 if (TypeID == null) {
						 error_message.Add(new ErrorMessage("TypeID", "TypeID can not be Null "));
				}
    	...
    	/* public void Write()
        {
            Type type = typeof(PriceAdjustRule); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.PriceAdjustRules.Contains(this))
            {
                previousValue.PriceAdjustRules.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.PriceAdjustRules.Contains(this))
                {
                    Store.PriceAdjustRules.Add(this);
                }
