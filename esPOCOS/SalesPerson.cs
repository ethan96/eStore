...
namespace eStore.POCOS
{
    public partial class SalesPerson
    {
    	...
    	public bool validate() {
		 ...
		 if (EmployeeID == null) {
						 error_message.Add(new ErrorMessage("EmployeeID", "EmployeeID can not be Null "));
				}
    	...
    	/* public void Write()
        {
            Type type = typeof(SalesPerson); // Get type pointer
        ...
        private void FixupStore(Store previousValue)
        {
            ...
            if (Store != null)
            {
                if (!Store.SalesPersons.Contains(this))
                {
                    Store.SalesPersons.Add(this);
                }
