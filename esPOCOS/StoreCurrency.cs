...
namespace eStore.POCOS
{
    public partial class StoreCurrency
    {
    	...
    	/* public void Write()
        {
            Type type = typeof(StoreCurrency); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.StoreCurrencies.Contains(this))
            {
                previousValue.StoreCurrencies.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.StoreCurrencies.Contains(this))
                {
                    Store.StoreCurrencies.Add(this);
                }
