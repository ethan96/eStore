...
namespace eStore.POCOS
{
    public partial class StoreFreightRate
    {
    	...
    	/* public void Write()
        {
            Type type = typeof(StoreFreightRate); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.StoreFreightRates.Contains(this))
            {
                previousValue.StoreFreightRates.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.StoreFreightRates.Contains(this))
                {
                    Store.StoreFreightRates.Add(this);
                }
