...
namespace eStore.POCOS
{
    public partial class StoreParameter
    {
        ...
        public virtual string SiteParameter
        {
            get;
            set;
        }
    	...
    	public bool validate() {
		 ...
		 if (SiteParameter == null) {
						 error_message.Add(new ErrorMessage("SiteParameter", "SiteParameter can not be Null "));
				}
    	...
    	/* public void Write()
        {
            Type type = typeof(StoreParameter); // Get type pointer
        ...
        {
            if (previousValue != null && previousValue.StoreParameters.Contains(this))
            {
                previousValue.StoreParameters.Remove(this);
            }
    
            if (Store != null)
            {
                if (!Store.StoreParameters.Contains(this))
                {
                    Store.StoreParameters.Add(this);
                }
